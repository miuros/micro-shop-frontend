  ...
  data() {
    ...
    */
    ...
    return {
      ...
      rules: {
        name: [{ reequired: true,message: 'name plz', trigger: "blur" },{min:3,max:20,message:'length in 3 and 20',trigger: 'blur'}],
  ...
  methods: {
    ...
    Login() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        ...
        if (valid) {
          this.$axios
            .post("/api/user/v1/login", this.$qs.stringify({
