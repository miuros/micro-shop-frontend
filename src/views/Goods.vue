...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      const api =
        this.categoryID.length == 0
          ? "http://miuros.fun:10000/api/pd/v1/list"
          : "http://miuros.fun:10000/api/pd/v1/listbycg";
      this.$axios
        .get(api+"?categoryId="+this.categoryID+"&page="+this.currentPage +"&limit="+this.pageSize, {
    ...
    getProductBySearch() {
      this.$axios
        .get("/api/pd/v1/list?"+"name="+this.search+"&page="+this.currentPage+"&limit="+this.pageSize, {
          name: this.search,
          page: this.currentPage,
          limit: this.pageSize
        })
