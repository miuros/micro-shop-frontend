...
<template>
  <div class="shoppingCart">
    ...
    <div class="content">
      <ul>
        <li class="header">
          <div class="pro-name">发送者</div>
          <div class="pro-price">内容</div>
          <div class="pro-num">时间</div>
        </li>
        <li class="product-list" v-for="(item,idx) in ntList" :key="idx">
...
export default {
  ...
  async created(){
    var res={};
    res=await this.$axios.get("/api/nt/v1/list?type=notice");
    if(res.data.code==='200'){
      this.ntList=res.data.data.data;
